      ...
      <section className="relative bg-vnpt-darker text-white py-20 overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/ctv/dashboard" className="bg-white text-vnpt px-8 py-4 rounded-full font-bold text-lg hover:bg-slate-100 transition-transform hover:scale-105 shadow-xl shadow-black/20 flex items-center gap-2">
              Vào Dashboard
